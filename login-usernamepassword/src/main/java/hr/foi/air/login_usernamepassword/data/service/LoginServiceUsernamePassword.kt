...
import hr.foi.air.login_usernamepassword.data.model.LoginResponseUsernamePassword
...
interface LoginServiceUsernamePassword {
    ...
    fun login(@Body userData: LoginRequest): Call<LoginResponseUsernamePassword>
